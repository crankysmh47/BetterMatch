...
import DNABackgroundLoader from '@/components/ui/DNABackgroundLoader';
import BackgroundUISkeleton from '@/components/ui/BackgroundUISkeleton';
import './globals.css';
...
export const metadata: Metadata = {
  ...
  icons: {
    icon: '/bettermatch-logo.png',
    apple: '/bettermatch-logo.png',
  },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className="dark">
      <body className={`${outfit.variable} ${spaceGrotesk.variable} ${ibmPlexMono.variable} min-h-screen text-[var(--text-primary)] font-sans theme-transition`} style={{ background: 'transparent' }}>
        {/* Global fixed DNA rotating in the background across all pages */}
        <DNABackgroundLoader />
        <BackgroundUISkeleton />
